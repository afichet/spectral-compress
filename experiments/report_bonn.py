...
def run_for(
    ...
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['width']    = width
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['height']   = height
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['size']     = size
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['ratio']    = ratio
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['rmse']     = rmse
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['q_curve']  = q_curve
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['c_curve']  = c_curve
    stats[dataset][variant][subsampling][technique][bits][c_dc][c_ac][q_flat][c_flat]['duration'] = duration
